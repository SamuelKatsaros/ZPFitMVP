...
struct HomeView: View {
    ...
    @State private var showTodaysWorkout = false
    ...
    var body: some View {
        NavigationStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        HeroSection(
                            ...
                            showTodaysWorkout: $showTodaysWorkout
                        )
            ...
            .fullScreenCover(isPresented: $showTodaysWorkout) {
                TodaysWorkoutView()
            }
        }
    }
    ...
    struct HeroSection: View {
        ...
        @Binding var selectedTab: MainTabView.Tab
        @Binding var showTodaysWorkout: Bool
                    ...
                    if viewModel.selectedProgram == nil {
                        ...
                        ZStack(alignment: .bottom) {
                            ...
                            HStack(alignment: .bottom) {
                                ...
                                // Start Button
                                Button(action: { showTodaysWorkout = true }) {
                                    if viewModel.completedToday {
                                        Text("View Workout")
                                            .font(.system(size: 14, weight: .bold))
                                            .foregroundStyle(Color.white)
